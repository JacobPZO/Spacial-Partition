    ...
    public class GameController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            for (int i = 0; i < numberOfSoldiers; i++)
            {
                ...
                Vector3 randomPos = new Vector3(UnityEngine.Random.Range(0f, mapWidth), 0.5f, UnityEngine.Random.Range(0f, mapWidth));
                ...
                randomPos = new Vector3(UnityEngine.Random.Range(0f, mapWidth), 0.5f, UnityEngine.Random.Range(0f, mapWidth));
